...
class DatasetHandler:
    ...
    def __init__(self):
        ...
        #root_dir_path = ''
        self.image_dir = os.path.join(root_dir_path, 'datasets/visual-odometry-data/rgb')
        self.depth_dir = os.path.join(root_dir_path, 'datasets/visual-odometry-data/depth')
    ...
    def _read_image(self):
        for i in range(1, self.num_frames + 1):
            ...
            print(im_name)
            img = cv.imread(im_name, flags=0)
            self.images.append(img)
            im = cv.imread(im_name)
            self.images_rgb.append(im[:, :, ::-1])
            print ("Data loading: {0}%".format(i), end="\r")
    ...
    def _read_depth(self):
        for i in range(1, self.num_frames + 1):
            ...
            print ("Data loading: {0} num depth".format(i), end="\r")
